...
public class NoteDetailsTests : BunitContext
{
	...
	private IRenderedComponent<NoteDetails> RenderWithAuth(
			Action<ComponentParameterCollectionBuilder<NoteDetails>>? parameters = null)
	{
