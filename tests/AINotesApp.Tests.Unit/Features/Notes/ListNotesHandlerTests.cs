...
// File Name :     ListNotesHandlerTests.cs
// Company :       mpaulosky
...
public class ListNotesHandlerTests
{
	...
	public async Task Handle_WithNotes_ReturnsCorrectPage()
	{
		...
		var notes = new List<Note>
		{
				new()
				{
						Id = Guid.NewGuid(), Title = "Note 1", OwnerSubject = ownerSubject,
						CreatedAt = DateTime.UtcNow.AddHours(-3), UpdatedAt = DateTime.UtcNow.AddHours(-1)
				},
				new()
				{
						Id = Guid.NewGuid(), Title = "Note 2", OwnerSubject = ownerSubject,
						CreatedAt = DateTime.UtcNow.AddHours(-2), UpdatedAt = DateTime.UtcNow
				},
				new()
				{
						Id = Guid.NewGuid(), Title = "Note 3", OwnerSubject = ownerSubject,
						CreatedAt = DateTime.UtcNow.AddHours(-1), UpdatedAt = DateTime.UtcNow.AddHours(-2)
				}
		};
	...
	public async Task Handle_DifferentUser_ReturnsOnlyUserNotes()
	{
		...
		_context.Notes.AddRange(
				new Note
				{
						Id = Guid.NewGuid(), Title = "User 1 Note", OwnerSubject = ownerSubject1, CreatedAt = DateTime.UtcNow,
						UpdatedAt = DateTime.UtcNow
				},
				new Note
				{
						Id = Guid.NewGuid(), Title = "User 2 Note", OwnerSubject = ownerSubject2, CreatedAt = DateTime.UtcNow,
						UpdatedAt = DateTime.UtcNow
				}
		);
