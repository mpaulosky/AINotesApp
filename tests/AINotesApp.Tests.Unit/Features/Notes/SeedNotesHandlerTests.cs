...
public class SeedNotesHandlerTests
{
	...
	public async Task Handle_WithValidUserId_CreatesMultipleNotes()
	{
		...
		var command = new SeedNotesCommand { UserId = userId, Count = 10 };
	...
	public async Task Handle_WhenAiServiceFails_ContinuesWithoutAiEnhancements()
	{
		// Arrange
		var userId = "test-user";
		var command = new SeedNotesCommand { UserId = userId, Count = 3 };
	...
	public async Task Handle_CreatesNotesWithDiverseTopics()
	{
		// Arrange
		var userId = "test-user";
		var command = new SeedNotesCommand { UserId = userId, Count = 15 };
	...
	public async Task Handle_RespectCountParameter()
	{
		...
		var command = new SeedNotesCommand { UserId = userId, Count = requestedCount };
	...
	public async Task Handle_SetsCreatedDateInPast()
	{
		// Arrange
		var userId = "test-user";
		var command = new SeedNotesCommand { UserId = userId, Count = 5 };
	...
	public async Task Handle_CallsAllAiServiceMethods()
	{
		// Arrange
		var userId = "test-user";
		var command = new SeedNotesCommand { UserId = userId, Count = 2 };
	...
	public async Task Handle_WithDefaultCount_Creates50Notes()
	{
		// Arrange
		var userId = "test-user";
		var command = new SeedNotesCommand { UserId = userId }; // Uses default Count = 50
	...
	public async Task Handle_SavesNotesInBatches()
	{
		// Arrange
		var userId = "test-user";
		var command = new SeedNotesCommand { UserId = userId, Count = 12 };
