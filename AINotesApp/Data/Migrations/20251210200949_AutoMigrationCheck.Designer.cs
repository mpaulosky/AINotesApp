...
namespace AINotesApp.Migrations
{
    ...
    [Migration("20251210200949_AutoMigrationCheck")]
    partial class AutoMigrationCheck
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AINotesApp.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AINotesApp.Data.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AINotesApp.Data.Note", b =>
                {
                    b.HasOne("AINotesApp.Data.ApplicationUser", "User")
                        .WithMany("Notes")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AINotesApp.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
